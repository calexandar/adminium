          ...
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2 flex items-center gap-x-3">
                @if ($news->getMedia('icons')->count())
                    <img src="{{ $news->getFirstMediaUrl('icons') }}" alt="" class="size-12 text-gray-300 dark:text-gray-500" />
                @else
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 dark:border-white/25">
                <div class="text-center">
                  ...
                  @if ($news->getMedia('news')->count())
                    <img src="{{ $news->getFirstMediaUrl('news') }}" alt="" class="mx-auto h-32 w-32 rounded-lg object-cover text-gray-300 dark:text-gray-500" />
                  @else
