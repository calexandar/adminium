    ...
    <div class="space-y-12">
      ...
      @foreach ($locales as $locale )
        <div x-show="activeTab === '{{ $locale }}'"  class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3 dark:border-white/10">
          <div>
            <h2 class="text-base/7 font-semibold text-gray-900 dark:text-white">Product Information</h2>
            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Product information can be used to help you quickly identify and manage your categories.</p>
          </div>
          ...
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            <div class="sm:col-span-3">
              ...
              <div class="mt-2">
                <input id="title" type="text" name="title[{{ $locale }}]" value="{{ $product->getTranslations('title')[$locale] }}" autocomplete="given-title" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" />
              </div>
              @error('title.*')
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                ...
                {{ $product->getTranslations('description')[$locale] }}
                </textarea>
              </div>
              <p class="mt-3 text-sm/6 text-gray-600 dark:text-gray-400">Write a description for your product.</p>
                @error('description.*')
                <p id="email-error" class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
              @enderror
            </div>
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                ...
                {{ $product->getTranslations('caption')[$locale] }}
                </textarea>
              </div>
            ...
            <div class="col-span-full">
              <label for="disclaimer" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Disclaimer</label>
              <div class="mt-2">
                <textarea id="disclaimer" name="disclaimer[{{ $locale }}]" rows="3" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500">
                {{ $product->getTranslations('disclaimer')[$locale] }}
                </textarea>
              </div>
              <p class="mt-3 text-sm/6 text-gray-600 dark:text-gray-400">Write a disclaimer that will show on hover.</p>
              @error('disclaimer.*')
                <p id="email-error" class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
              @enderror
            </div>
            ...
            <div class="sm:col-span-4">
              ...
              <div class="mt-2">
                <input id="meta_title" type="text" name="meta_title[{{ $locale }}]"  value="{{ $product->getTranslations('meta_title')[$locale] }}" autocomplete="given-title" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" />
              </div>
              @error('meta_title.*')
                <p id="email-error" class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
              @enderror
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <textarea id="meta_description" name="meta_description[{{ $locale }}]"  rows="3" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500">
                  {{ $product->getTranslations('meta_description')[$locale] }}
                </textarea>
              </div>
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <input id="meta_keywords" type="text" name="meta_keywords[{{ $locale }}]" value="{{ $product->getTranslations('meta_keywords')[$locale] }}" autocomplete="given-meta_keywords" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" />
              </div>
              @error('meta_keywords.*')
                <p id="email-error" class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
              @enderror
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3 dark:border-white/10">
          <div>
            <h2 class="text-base/7 font-semibold text-gray-900 dark:text-white">Common product Information</h2>
            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Common product information that is not translatable can be used to help you quickly identify and manage your categories.</p>
          </div>
          ...
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            ...
            <div class="sm:col-span-3">
              ...
              @error('slug')
                <p id="slug-error" class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
              @enderror
            </div>
            ...
            <div class="sm:col-span-3">
              <div class="flex items-center gap-x-3">
                ...
                <div class="text-sm">
                  ...
                  @error('new_product')
                  <p id="new_product-error" class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                  @enderror
            </div>
            ...
            <div class="sm:col-span-3">
              <div class="flex items-center gap-x-3">
                <div class="group relative inline-flex w-11 shrink-0 rounded-full bg-gray-200 p-0.5 inset-ring inset-ring-gray-900/5 outline-offset-2 outline-indigo-600 transition-colors duration-200 ease-in-out has-checked:bg-indigo-600 has-focus-visible:outline-2 dark:bg-white/5 dark:inset-ring-white/10 dark:outline-indigo-500 dark:has-checked:bg-indigo-500">
                  ...
                  <input id="published" type="checkbox" name="published" value="1" aria-labelledby="published-label" aria-describedby="published-description" class="absolute inset-0 appearance-none focus:outline-hidden" {{ ($product->published) ? 'checked' : '' }}/>
                </div>
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2 flex items-center gap-x-3">
                @if ($product->getMedia('icons')->count())
                    <img src="{{ $product->getFirstMediaUrl('icons') }}" alt="" class="size-12 text-gray-300 dark:text-gray-500" />
                @else
              ...
              @error('icon')
                <p id="icon" class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
              @enderror
            </div>
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 dark:border-white/25">
                <div class="text-center">
                  <img id="preview" class="mx-auto mb-4 hidden max-h-48 rounded-md object-contain" />
                  @if ($product->getMedia('products')->count())
                    <img src="{{ $product->getFirstMediaUrl('products') }}" alt="" class="mx-auto h-32 w-32 rounded-lg object-cover text-gray-300 dark:text-gray-500" />
                  @else
                    <svg id="upload-icon" viewBox="0 0 24 24" fill="currentColor" data-slot="icon" aria-hidden="true" class="mx-auto size-12 text-gray-300 dark:text-gray-600">
                      <path d="M1.5 6a2.25 2.25 0 0 1 2.25-2.25h16.5A2.25 2.25 0 0 1 22.5 6v12a2.25 2.25 0 0 1-2.25 2.25H3.75A2.25 2.25 0 0 1 1.5 18V6ZM3 16.06V18c0 .414.336.75.75.75h16.5A.75.75 0 0 0 21 18v-1.94l-2.69-2.689a1.5 1.5 0 0 0-2.12 0l-.88.879.97.97a.75.75 0 1 1-1.06 1.06l-5.16-5.159a1.5 1.5 0 0 0-2.12 0L3 16.061Zm10.125-7.81a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0Z" clip-rule="evenodd" fill-rule="evenodd" />
                    </svg>
                  @endif
                  <div class="mt-4 flex justify-center text-sm/6 text-gray-600 dark:text-gray-400">
                    <label for="cover_image" class="relative cursor-pointer rounded-md bg-transparent font-semibold text-indigo-600 hover:text-indigo-500 focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-indigo-600 dark:text-indigo-400 dark:hover:text-indigo-300 dark:focus-within:outline-indigo-500">
                  ...
                  <p class="mt-1 text-xs/5 text-gray-600 dark:text-gray-400">
                      PNG, JPG, GIF, WEBP, AVIF up to 10MB
                  </p>
                </div>
              </div>
              @error('cover_image')
