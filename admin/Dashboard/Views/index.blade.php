...
@section('content')
    <ul role="list" class="grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-3 xl:gap-x-8">
            ...
            <div
                ...
                <el-dropdown class="relative ml-auto">
                    ...
                    <el-menu anchor="bottom end" popover
                        ...
                        <a href="#"
                            class="block px-3 py-1 text-sm/6 text-gray-900 focus:bg-gray-50 focus:outline-hidden dark:text-white dark:focus:bg-white/5">Edit<span
                                class="sr-only">, Tuple</span></a>
                    </el-menu>
                </el-dropdown>
            </div>
        ...
        <li class="overflow-hidden rounded-xl outline outline-gray-200 dark:-outline-offset-1 dark:outline-white/10">
            <div
                class="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-6 dark:border-white/10 dark:bg-gray-800/50">
                <img src="https://tailwindcss.com/plus-assets/img/logos/48x48/savvycal.svg" alt="SavvyCal"
                    class="size-12 flex-none rounded-lg bg-white object-cover ring-1 ring-gray-900/10 dark:bg-gray-700 dark:ring-white/10" />
        ...
        <li class="overflow-hidden rounded-xl outline outline-gray-200 dark:-outline-offset-1 dark:outline-white/10">
            <div
                class="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-6 dark:border-white/10 dark:bg-gray-800/50">
                <img src="https://tailwindcss.com/plus-assets/img/logos/48x48/reform.svg" alt="Reform"
                    class="size-12 flex-none rounded-lg bg-white object-cover ring-1 ring-gray-900/10 dark:bg-gray-700 dark:ring-white/10" />
