          ...
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                ...
                {{ $article->getTranslations('description')[$locale] }}
                </textarea>
              </div>
              <p class="mt-3 text-sm/6 text-gray-600 dark:text-gray-400">Write a description for your article.</p>
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                ...
                {{ $article->getTranslations('caption')[$locale] }}
                </textarea>
              </div>
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <input id="meta_keywords" type="text" name="meta_keywords[{{ $locale }}]" value="{{ $article->getTranslations('meta_keywords')[$locale] }}" autocomplete="given-meta_keywords" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" />
              </div>
          ...
          <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2 flex items-center gap-x-3">
                @if ($article->getMedia('icons')->count())
                    <img src="{{ $article->getFirstMediaUrl('icons') }}" alt="" class="size-12 text-gray-300 dark:text-gray-500" />
                @else
              ...
              <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 dark:border-white/25">
                <div class="text-center">
                  @if ($article->getMedia('articles')->count())
                    <img src="{{ $article->getFirstMediaUrl('articles') }}" alt="" class="mx-auto h-12 w-12 text-gray-300 dark:text-gray-500" />
                  @else
