      ...
      @foreach ($locales as $locale )
        <div x-show="activeTab === '{{ $locale }}'" class="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3 dark:border-white/10">
          <div>
            ...
            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Article information that is translatable can be used to help you quickly identify and manage your articles.</p>
          </div>
